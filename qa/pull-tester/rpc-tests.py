...
testScripts = [ RpcTest(t) for t in [
    ...
    'disablewallet',
    'extversion',
    Disabled('fundrawtransaction', "assertion failure"),
    'getlogcategories',
    Disabled('getrawtransaction', "bad-cb-payout-dest"),
    Disabled('grouptokens', "Subblock tx index beyond length of vtx. Did you call UpdateTxLists first?"),
    Disabled('importprunedfunds', "No such mempool transaction"),
    Disabled('invalidtxrequest', "Assertion failed: Not all nodes requested block"),
    Disabled('miningtest', "ConnectTipTailstorm error"),
    Disabled('parallel', "sync_blocks: blocks did not sync through various nodes before the timeout of 20 seconds kicked in"),
    Disabled('prioritise_transaction', "Subblock tx index beyond length of vtx. Did you call UpdateTxLists first?"),
    Disabled('rawtransactions', "Subblock tx index beyond length of vtx. Did you call UpdateTxLists first?"),
    Disabled('rest', "assert_equal failed: 0E-8 != 0.1"),
    Disabled('rpc_getblockstats', "JSONRPC error: Target block height 101 after current tip 0"),
    Disabled('schnorrsig', "sync_blocks timeout"),
    Disabled('segwit_recovery', "assertion failed, script flags mismatch"),
    Disabled('sendheaders', "Assertion failed: Sync failed to complete"),
    Disabled('sighashmatch', "mandatory-script-verify-flag-failed (Script failed an OP_EQUALVERIFY operation)"),
    'signrawtransactions',
    'ts_tailstorm',
    'ts_compact',
    'ts_graphene',
    'ts_subblocks',
    'uptime',
    Disabled('wallet', "assert_equal failed: 3 != 1"),
    Disabled('wallet-hd', "TestTailstormBlockValidity failed: bad-extra-txn"),
    'zapwallettxes',



    Disabled('abandonconflict', "needs adjustment for tailstorm"),
    Disabled('bip135basic', "needs adjustment for tailstorm"),
    Disabled('blockchain', "needs adjustment for tailstorm"),
    Disabled('blockstorage', "needs adjustment for tailstorm"),
    Disabled('cashlibtest', "needs adjustment for tailstorm"),
    Disabled('compactblocks_1', "needs adjustment for tailstorm"),
    Disabled('compactblocks_2', "needs adjustment for tailstorm"),
    Disabled('excessive', "needs adjustment for tailstorm"),
    Disabled('finalizeblock', "needs adjustment for tailstorm"),
    Disabled('graphene_optimized', "needs adjustment for tailstorm"),
    Disabled('graphene_stage2', "needs adjustment for tailstorm"),
    Disabled('graphene_versions', "needs adjustment for tailstorm"),
    Disabled('getchaintips', "needs adjustment for tailstorm"),
    Disabled('httpbasics', "needs adjustment for tailstorm"),
    Disabled('keypool', "needs adjustment for tailstorm"),
    Disabled('listtransactions', "needs adjustment for tailstorm"),
    Disabled('mempoolsync', "needs adjustment for tailstorm"),
    Disabled('mempool_accept', "needs adjustment for tailstorm"),
    Disabled('mempool_limit', "needs adjustment for tailstorm"),
    Disabled('mempool_persist', "needs adjustment for tailstorm"),
    Disabled('mempool_reorg', "needs adjustment for tailstorm"),
    Disabled('mempool_resurrect_test', "needs adjustment for tailstorm"),
    Disabled('mempool_spendcoinbase', "needs adjustment for tailstorm"),
    Disabled('mempool_validate', "needs adjustment for tailstorm"),
    Disabled('merkle_blocks', "needs adjustment for tailstorm"),
    Disabled('minimaldata', "needs adjustment for tailstorm"),
    Disabled('mining_ctor', "needs adjustment for tailstorm"),
    Disabled('multi_rpc', "needs adjustment for tailstorm"),
    Disabled('nodehandling', "needs adjustment for tailstorm"),
    Disabled('notify', "needs adjustment for tailstorm"),
    Disabled('proxy_test', "needs adjustment for tailstorm"),
    Disabled('receivedby', "needs adjustment for tailstorm"),
    Disabled('reindex', "needs adjustment for tailstorm"),
    Disabled('schnorrmultisig', "needs adjustment for tailstorm"),
    Disabled('thinblocks', "needs adjustment for tailstorm"),
    Disabled('tweak', "needs adjustment for tailstorm"),
    Disabled('txindex', "needs adjustment for tailstorm"),
    Disabled('txn_doublespend --mineblock', "needs adjustment for tailstorm"),
    Disabled('txn_clone', "needs adjustment for tailstorm"),
    Disabled('validateblocktemplate', "needs adjustment for tailstorm"),
    Disabled('wallet-dump', "needs adjustment for tailstorm"),
...
#Enable ZMQ tests
if ENABLE_ZMQ == 1:
    # Disabled ZMQ tests need tailstorm adjustment
