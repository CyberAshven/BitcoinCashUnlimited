...
testScripts = [ RpcTest(t) for t in [
    ...
    'schnorrsig',
    'mining_ctor',
    Disabled('mining_adaptive_blocksize', "TODO: need to nail down the block header size before getting this to work"),
    Disabled('blockstorage', "TODO: not important for now and may be related to the headers and genesis"),
    Disabled('miningtest', "TODO: need to get mininode working with tailstorm blocks"),
    'cashlibtest',
    'tweak',
    'notify',
    Disabled('validateblocktemplate', "TODO: need to get mininode working with tailstorm blocks"),
    'parallel',
    'wallet',
    'wallet-hd',
    'wallet-dump',
    ...
    'getchaintips',
    'rawtransactions',
    Disabled('rest', " TODO: partially updated to work with multi output coinbase however still need mininode updated for it to work"),
    'mempool_accept',
    ...
    'blockchain',
    'disablewallet',
    Disabled('sendheaders', "TODO: need to get mininode working with tailstorm blocks"),
    'keypool',
    'prioritise_transaction',
    Disabled('invalidtxrequest', "TODO: need to get mininode working with tailstorm blocks"),
    'abandonconflict',
    'importprunedfunds',
    'compactblocks_1',
    Disabled('compactblocks_2', "TODO: need to get mininode working with tailstorm blocks"),
    'graphene_optimized',
    'graphene_versions',
    'graphene_stage2',
    'thinblocks',
