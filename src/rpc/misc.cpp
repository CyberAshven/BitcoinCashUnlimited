...
UniValue validateaddress(const UniValue &params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"isminepartial\" : true|false, (boolean) If the address is multisig and you contorl at least 1 key but not all of them\n"
    ...
    if (isValid)
    {
        ...
        ret.pushKV("isminepartial", (mine & ISMINE_PARTIAL) ? true : false);
