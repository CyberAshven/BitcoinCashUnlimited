...
public:
    ...
    int SetMerkleBranch(const CBobtailBlock &block, int txIndex);
...
public:
    ...
    void SyncTransaction_BT(const CTransactionRef &ptx, const CBobtailBlock *pblock, int txIndex = -1);
    ...
    bool AddToWalletIfInvolvingMe(const CTransactionRef &ptx, const CBobtailBlock *pblock, bool fUpdate, int txIndex = -1);
